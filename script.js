 !(function (t) {
  ...
  function (t, e, n) {
    ...
    function p(t) {
      i.env() &&
        (d(t.design) && u.on("__wf_design", t.design),
        d(t.preview) && u.on("__wf_preview", t.preview)),
        d(t.destroy) && u.on("__wf_destroy", t.destroy),
        t.ready &&
          d(t.ready) &&
          (function (t) {
    ...
    function m(t) {
      d(t.design) && u.off("__wf_design", t.design),
        d(t.preview) && u.off("__wf_preview", t.preview),
        d(t.destroy) && u.off("__wf_destroy", t.destroy),
        t.ready &&
          d(t.ready) &&
          (function (t) {
  ...
  function (t, e, n) {
    ...
    window.tram = (function (t) {
      ...
      var d = (function (t, e, n) {
          ...
          return function i(s, u) {
            ...
            return (
              ...
              (c.open = function (t) {
                if (
                  ((l = {}),
                  o(t) ? (l = t.call(c, h, f, c, s)) : r(t) && (l = t),
                  r(l))
                )
        ...
        C = function (t) {
          ...
          for (e = 0; e < T.length; e++)
            if ((n = T[e] + i) in L.style) return { dom: n, css: R[e] + t };
        },
        S = (e.support = {
        ...
        D = d(function (e) {
          ...
          function h(t, e, i) {
            ...
            for (o in t)
              (s = t[o]),
                o in Z
                  ? (d.transform || (d.transform = {}), (d.transform[o] = s))
                  : (w.test(o) && (o = n(o)),
                    o in Y ? (d[o] = s) : (u || (u = {}), (u[o] = s)));
            for (o in d) {
              ...
              U.fallback || i.fallback
                ...
                : ((this.animate = this.transition),
                  (this.string =
                    ...
                    this.duration +
                    "ms" +
                    ("ease" != this.ease ? O + l[this.ease][0] : "") +
        ...
        q = d(function (e) {
          function n() {
            var t,
              ...
              i,
              r = u.length;
            if (r) for (M(n), e = W(), t = r; t--; ) (i = u[t]) && i.render(e);
          }
      ...
      var X = t.style,
        G = t.css,
        K = { transform: S.transform && S.transform.css },
        Y = {
          color: [$, b],
          ...
          return function (e) {
            e
              ? ((e.thirdPartyCookiesSupported = t),
                h(p(e.bugReporterScriptPath), function () {
        ...
        function w(e) {
          ...
          if (
            ...
            var c,
              l =
                ((c = a),
                v.test(c.hash) && c.host + c.pathname === n.host + n.pathname
                  ? a.hash
                  : "");
            if ("" !== l) {
              var f = t(l);
      ...
      (t.exports = function (t) {
        ...
        function i(e) {
          ...
          e.addEventListener("touchstart", u, !1),
            ...
            e.addEventListener("mouseup", d, !1),
            ...
            (this.destroy = function () {
              e.removeEventListener("touchstart", u, !1),
                ...
                e.removeEventListener("mouseup", d, !1),
        ...
        function $(t, e) {
          if (!t.open) {
            ...
            if (
              ...
              var h = u + o;
              d(t.menu).add(l).set({ y: -h }).start({ y: 0 }).then(v);
            }
          }
          function v() {
        ...
        function j(t, e) {
          if (t.open) {
            ...
            if (n.animOver)
              ...
              var s = a + r;
              d(t.menu).add(i).start({ y: -s }).then(u);
            }
          }
          function u() {
            t.menu.height(""),
  ...
  function (t, e, n) {
    ...
    i.define(
      ...
      (t.exports = function (t, e) {
        ...
        function b() {
          (n = l.find(h)).length &&
            (n.each(k), u || (y(), i.resize.on(x), i.redraw.on(c.redraw)));
        }
        function y() {
        ...
        function k(e, n) {
          ...
          if (
            ...
            s || r.ariaLiveLabel || (r.ariaLiveLabel = t(p).appendTo(r.mask)),
          ...
          r.el.off(h),
            ...
            s
              ...
              : (r.el.on("swipe" + h, S(r)),
                ...
                r.left.on("keydown" + h, O(r, L)),
                r.right.on("keydown" + h, O(r, T)),
          ...
          return function (r, a) {
            ...
            if (s && "setting" === r.type) {
              ...
              if (n.nav.has(r.target).length) {
                ...
                if (
                  ("click" === r.type && z(n, { index: c }),
                  "keydown" === r.type)
                )
                  switch (r.keyCode) {
                    case o.ENTER:
                    case o.SPACE:
                      z(n, { index: c }), r.preventDefault();
                      break;
                    case o.ARROW_LEFT:
                    case o.ARROW_UP:
        ...
        function z(e, n) {
          ...
          if (
            ...
            s || (v.each(w.intro), m.each(w.outro)),
            n.immediate && !g)
          )
            return d(v).set(h), void L();
          if (e.index !== e.previous) {
            if (
              ...
              return (
                (E = "opacity " + A + "ms " + y),
                d(p).set({ visibility: "" }).add(E).start({ opacity: 0 }),
                void d(v)
            ...
            i.infinite && u.x
              ...
              : (i.infinite &&
                  e.shifted &&
                  (d(e.shifted).set({ visibility: "", x: l }),
                  (e.shifted = null)),
                d(e.slides).set({ visibility: "" }).add(_).start({ x: f }));
          }
          function L() {
            (v = t(r[e.index].els)),
              (m = e.slides.not(v)),
